...
const Home = () => {
  ...
  const fixImageUrl = (url) => {
    ...
    fixedUrl = fixedUrl.replace('http://localhost:8001/api/', 'https://barber-fullstack-fix.preview.emergentagent.com/api/');
  ...
  return (
    <div className="min-h-screen bg-black text-gold">
      ...
      <section id="services" className="py-20 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gold mb-4 font-serif">{t('services.title')}</h2>
      ...
      <section id="contact" className="py-20 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gold mb-4 font-serif">{t('contact.title')}</h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
