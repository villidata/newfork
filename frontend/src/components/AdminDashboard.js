...
import { Calendar, Users, Settings, LogOut, User, Scissors, Clock, Mail, Phone, Plus, Edit, Trash2, Save, X, Upload, Image, FileText, CreditCard, Globe, TrendingUp, Coffee, Home, Instagram, Facebook, Youtube, Linkedin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="bookings" className="space-y-6">
          <TabsList className="bg-gray-900/50 border border-gold/20">
            ...
            <TabsTrigger value="homepage" className="data-[state=active]:bg-gold data-[state=active]:text-black">
