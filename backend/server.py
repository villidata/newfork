...
async def create_paypal_payment(booking_id: str, amount: float = None):
    ...
    try:
        ...
        payment = paypalrestsdk.Payment({
            ...
            "redirect_urls": {
                "return_url": f"https://barberedit.preview.emergentagent.com/payment/success?booking_id={booking_id}",
                "cancel_url": f"https://barberedit.preview.emergentagent.com/payment/cancel?booking_id={booking_id}"
            },
            "transactions": [{
                "item_list": {
                    "items": [{
