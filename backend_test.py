...
class FrisorLaFataAPITester:
    def __init__(self, base_url="https://retro-barber.preview.emergentagent.com"):
    ...
    def _test_avatar_upload_file_type(self, filename, content_type):
        ...
        try:
            ...
            if success:
                ...
                # Verify URL format
                expected_domain = "https://retro-barber.preview.emergentagent.com"
    ...
    def test_database_avatar_urls_consistency(self):
        ...
        for staff in staff_list:
            ...
            if avatar_url:
                ...
                elif avatar_url.startswith('https://retro-barber.preview.emergentagent.com'):
                    correct_urls.append({
                        'name': staff.get('name', 'Unknown'),
                        'avatar_url': avatar_url
                    })
    ...
    def test_enhanced_page_model(self):
        ...
        for page_type in page_types:
            page_data = {
                ...
                "page_type": page_type,
                "featured_image": f"https://retro-barber.preview.emergentagent.com/uploads/images/featured-{page_type}.jpg",
                "images": [
                    f"https://retro-barber.preview.emergentagent.com/uploads/images/gallery-{page_type}-1.jpg",
                    f"https://retro-barber.preview.emergentagent.com/uploads/images/gallery-{page_type}-2.jpg"
                ],
                "videos": [
                    f"https://retro-barber.preview.emergentagent.com/uploads/videos/demo-{page_type}.mp4"
                ],
    ...
    def test_page_crud_enhanced_features(self):
        ...
        enhanced_page_data = {
            ...
            "navigation_order": 10,
            "page_type": "service",
            "featured_image": "https://retro-barber.preview.emergentagent.com/uploads/images/featured-service.jpg",
            "images": [
                "https://retro-barber.preview.emergentagent.com/uploads/images/gallery-1.jpg",
                "https://retro-barber.preview.emergentagent.com/uploads/images/gallery-2.jpg",
                "https://retro-barber.preview.emergentagent.com/uploads/images/gallery-3.jpg"
            ],
            "videos": [
                "https://retro-barber.preview.emergentagent.com/uploads/videos/demo-1.mp4",
                "https://retro-barber.preview.emergentagent.com/uploads/videos/demo-2.webm"
            ],
        ...
        update_data = {
            ...
            "navigation_order": 15,
            "videos": [
                "https://retro-barber.preview.emergentagent.com/uploads/videos/updated-demo.mp4"
            ]
        }
    ...
    def _analyze_image_url(self, url, context):
        ...
        if not url.startswith('https://retro-barber.preview.emergentagent.com'):
